...
const PastEvents = () => (
  <Layout title='Past Events'>
    <section className='event top-event'>
      <h3>Bonfire Night Sat 6th Nov 2021</h3>
      <p>
        The Dewlish Bonfire &amp; Firework extravaganza on Sat. 6th. Nov. very
        much lived up to the pre-event publicity! There was an element of folks
        being released from Covid restraints as car parking was nil problem, the
        live band created a thread of sound to permeate the nearby BBQ, cake
        stall, soup &amp; roll + other catering tents, not forgetting the ever
        busy bar – and the madding throng were kept entertained, fed and
        watered. The bonfire then blazed into the night spreading a welcome heat
        on a tad fresh evening before the fireworks crowned the occasion. This
        was a display which would not have been out of place in any nearby large
        town or other major conurbation such was the sheer magnificence of the
        truly awesome spectacle. Suffice to say, these happenings do not conduct
        themselves and thanks must be said to the many villagers who staffed and
        ran the stalls, parking and the flash, bang, whoosh firework show.
        Particular thanks though, must go to the John Martins, Snr. &amp; Jnr.,
        who not only allowed the fields to be used but provided &amp; built the
        bonfire itself. Good people!
      </p>
      <p>
